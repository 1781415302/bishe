...
public:
     ...
     * Declaring Write_Pos()
     */
    void Write_Pos(float data);
    void Write_Pos();

    void Write_IO_Yaw_Target(float data);
    void Write_IO_Yaw_Target();
    void Write_IO_Roll_Target(float data);
    void Write_IO_Roll_Target();
    void Write_IO_Pitch_Target(float data);
    void Write_IO_Pitch_Target();

    void Write_IO_Yaw_Rate(float data);
    void Write_IO_Yaw_Rate();
    void Write_IO_Roll_Rate(float data);
    void Write_IO_Roll_Rate();
    void Write_IO_Pitch_Rate(float data);
    void Write_IO_Pitch_Rate();

    void Write_IO_Roll(float data);
    void Write_IO_Roll();

    void Write_IO_Pitch(float data);
    void Write_IO_Pitch();
...
#define AC_ATTITUDE_CONTROL_LOG_FORMAT(msg) { msg, sizeof(AC_AttitudeControl::log_Attitude),"ATT", "cccccCC",      "RollIn,Roll,PitchIn,Pitch,YawIn,Yaw,NavYaw" }