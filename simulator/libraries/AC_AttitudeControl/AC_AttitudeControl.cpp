...
void AC_AttitudeControl::input_quaternion(Quaternion attitude_desired_quat)
{
     ...
     */
    // Target angles
    //Write_IO(_attitude_target_euler_angle.x);
    //Write_IO(_attitude_target_euler_angle.y);
    //Write_IO(_attitude_target_euler_angle.z);
...
void AC_AttitudeControl::input_euler_angle_roll_pitch_yaw(float euler_roll_angle_cd, float euler_pitch_angle_cd, float euler_yaw_angle_cd, bool slew_yaw)
{
	...
	_piper.getPosControlXY(AC_AttitudeControl::accX, AC_AttitudeControl::accY, AC_AttitudeControl::accZ,
			...
			AC_AttitudeControl::velErrorX, AC_AttitudeControl::velErrorY,
                _ahrs.roll_sensor, _ahrs.pitch_sensor, _ahrs.yaw_sensor, AC_AttitudeControl::attackLabel);
...
/*
void AC_AttitudeControl::Write_IO_Yaw_Target(float data)
{
    MyPIDio::write_to_file_yaw_target(data);
}

void AC_AttitudeControl::Write_IO_Yaw_Target()
{
    MyPIDio::write_to_file_yaw_target();
}

void AC_AttitudeControl::Write_IO_Roll_Target(float data)
{
    MyPIDio::write_to_file_roll_target(data);
}

void AC_AttitudeControl::Write_IO_Roll_Target()
{
    MyPIDio::write_to_file_roll_target();
}

void AC_AttitudeControl::Write_IO_Pitch_Target(float data)
{
    MyPIDio::write_to_file_pitch_target(data);
}

void AC_AttitudeControl::Write_IO_Pitch_Target()
{
    MyPIDio::write_to_file_pitch_target();
}

void AC_AttitudeControl::Write_IO_Yaw_Rate(float data)
{
    MyPIDio::write_to_file_yaw_rate(data);
}

void AC_AttitudeControl::Write_IO_Yaw_Rate()
{
    MyPIDio::write_to_file_yaw_rate();
}

void AC_AttitudeControl::Write_IO_Roll_Rate(float data)
{
    MyPIDio::write_to_file_roll_rate(data);
}

void AC_AttitudeControl::Write_IO_Roll_Rate()
{
    MyPIDio::write_to_file_roll_rate();
}

void AC_AttitudeControl::Write_IO_Pitch_Rate(float data)
{
    MyPIDio::write_to_file_pitch_rate(data);
}

void AC_AttitudeControl::Write_IO_Pitch_Rate()
{
    MyPIDio::write_to_file_pitch_rate();
}
*/
        ...
        int _attack_label)
{
    ...
    AC_AttitudeControl::attackLabel = (_attack_label != 0) ? 1 : 0;
}
...
void AC_AttitudeControl::startTimer()
{
    ...
    AC_AttitudeControl::tStartPID = clock();
    AC_AttitudeControl::tStartRPY = clock();
}

void AC_AttitudeControl::startTimerPID()
{
    AC_AttitudeControl::tStartPID = clock();
}

void AC_AttitudeControl::startTimerRPY()
{
    AC_AttitudeControl::tStartRPY = clock();
}
...
int AC_AttitudeControl::checkTimeDelayAttack()
{
    ...
    if((double)(tEnd-tStart)/216000 > 20)
    {
        startTimer();
        return 1;
    }
...
int AC_AttitudeControl::checkTime_yaw_roll_pitch()
{
    clock_t tEnd = clock();
    if((double)(tEnd-tStart)/216000 > 1)
    {
        startTimer();
        return 1;
    }
...
int AC_AttitudeControl::checkTimePID_IO()
{
    clock_t tEnd = clock();
    if((double)(tEnd-tStart)/216000 > 1)
    {
